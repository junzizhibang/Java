 ...
 * 开发人员: 马琳-君子自强，脚踏实地积累 
 * 开发时间: ${date} ${time}  今年一定要成为Java高级开发攻城狮 
 * v1.0.0.0 ${date}-01  [Ideal]  1217575485@qq.com        
 * 初始版本基础夯实积攒Java架构师的基础内容  
 *******************************************/

/**
 * 功能说明：  随机生成姓名，手机号，邮箱，性别
 * 初始版本基础夯实积攒Java架构师的基础内容
 *
...
public class GenerateUserInfo {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("随机生成年纪：" + num);
        String email = getEmail(1, 5);
        String telNum = getTelephone();
        String name = getChineseName();
        String phone = getLandline();
        System.out.println("随机生成email：" + email);
        System.out.println("随机手机号码：" + telNum);
        System.out.println("随机生成姓名：" + name);
        System.out.println("随机电话号码：" + phone);
